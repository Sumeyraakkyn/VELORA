...
class CodeWalkerService {
    ...
    isTheSameCodeWalkerservice(projectPath) {
        return this.rootPath === projectPath;
    }
    hasTheSameDependencySettings(packageDefaultDependenciesDirectory, packageDefaultDependenciesContractsDirectory, remappings) {
    ...
    parseDocumentReference(documentText, fixedSource, sourceDocument) {
