...
class Compiler {
    constructor(solcCachePath) {
        ...
        this.outputChannel = outputChannelService_1.OutputChannelService.getInstance().getSolidityCompilerOutputChannel();
    }
    ...
    processCompilationOutput(outputString, outputChannel, diagnosticCollection, buildDir, sourceDir, rootPath, excludePath, singleContractFilePath) {
    ...
    writeCompilationOutputToBuildDirectory(output, buildDir, sourceDir, rootPath, excludePath, singleContractFilePath) {
